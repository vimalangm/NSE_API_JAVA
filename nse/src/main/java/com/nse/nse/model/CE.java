...
public class CE {
	...
	public CE(int strikePrice, String expiryDate, String underlying, String identifier, double openInterest,
			int changeinOpenInterest, double pchangeinOpenInterest, int totalTradedVolume, int impliedVolatility,
	...
	public String toString() {
		return "CE [strikePrice=" + strikePrice + ", expiryDate=" + expiryDate + ", underlying=" + underlying
